package com.ptut.canvasexample.tictactoe
...
private fun updateGameState(
    ...
    val newGameState = gameState.copyOf()
    newGameState[i][j] = symbol
    return newGameState
}

private fun CoroutineScope.animateFloatToOne(animation: Animatable<Float, AnimationVector1D>) {
    launch {
        animation.animateTo(
            targetValue = 1f,
...
fun emptyGameState(): Array<CharArray> {
    return arrayOf(
        charArrayOf('E', 'E', 'E'),
        charArrayOf('E', 'E', 'E'),
        charArrayOf('E', 'E', 'E')
